...
<div class="card">
  <h3>Статистика билети</h3>
  <p>
    Общо генерирани: <b><?=h($totalTickets)?></b><br>
    Използвани: <b><?=h($usedTickets)?></b><br>
    Свободни: <b><?=h($totalTickets - $usedTickets)?></b>
  </p>
</div>
<div class="container">
  <div class="card">
